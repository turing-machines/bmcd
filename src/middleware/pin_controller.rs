...
impl PinController {
    ...
    pub fn new() -> anyhow::Result<Self> {
        ...
        let usb_mux =
            setup_output_array!(chip0, [USB_SEL1, USB_OE1, USB_SEL2, USB_OE2], Active::High);

        let usb_switch = setup_output_array!(chip0, [USB_SWITCH], Active::High);
        let rtl_reset = setup_output_array!(chip0, [RTL_RESET], Active::Low);
